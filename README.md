...
## Features
  ...
  - **Core Package**: Filesystem-agnostic CSP processing with optional filesystem cache integration
  - **Build Plugins**: Vite, Webpack, Rollup, and esbuild plugins for asset tracking
  - **CLI Tool**: Post-build CSP processing with persistent caching
  - **Filesystem Cache**: Optional persistent caching to avoid refetching resources between runs
